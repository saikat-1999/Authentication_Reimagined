...
public class AadharNumberFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        enter_aadhar = getView().findViewById(R.id.aadhar_no);
        captcha = getActivity().findViewById(R.id.generate_captcha);
        ...
        captcha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getContext(), enter_aadhar.getText().toString().replace(" ",""), Toast.LENGTH_SHORT).show();
            }
        });
    }
}